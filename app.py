...
async def predictRouteClient(request: Request):
    try:
        ...
        # Print gathered form data
        print("Form Data Received:", vars(form))

        # Create USvisaData instance
        usvisa_data = USvisaData(
            continent=form.continent,
            education_of_employee=form.education_of_employee,
            has_job_experience=form.has_job_experience,
        ...
        print("Transformed DataFrame for Prediction:", usvisa_df)
        ...
        print(f"Raw Model Output: {value}")
